...
def check_parameter(para_list):
    ...
    para_help = \
        ...
        'rki'  -- Stitch for Rock Island board
...
def get_xml_change_list (platform, plt_params_list):
    ...
    if 'rki' in plt_params_list:
        ...
        ('./FlexIO/Usb3PortConfiguration/USB3Port3SpdCap',                           'USB 3.1 Gen1'),
        ('./FlexIO/Usb3PortConfiguration/USB3Port4SpdCap',                           'USB 3.1 Gen1'),
        ('./FlexIO/Usb3PortConfiguration/USB3Prt4ConTypeSel',                        'Express Card / M.2 S2'),
        ...
        ('./FlexIO/Usb2PortConfiguration/USB2Prt10ConTypeSel',                       'Express Card / M.2 S2'),
        ('./FlexIO/Type-CSubsystemConfiguration/TypeCPort1Config',                   'DP Fixed Connection'),
        ('./FlexIO/Type-CSubsystemConfiguration/TypeCPort2Config',                   'DP Fixed Connection'),
        ('./FlexIO/Type-CSubsystemConfiguration/TypeCPort3Config',                   'No Thunderbolt'),
        ('./FlexIO/Type-CSubsystemConfiguration/TypeCPort4Config',                   'No Thunderbolt'),
        ...
        ('./FlexIO/PowerDelivery_PdControllerConfiguration/TypeCPort3RetimerConfig', 'No'),
        ('./FlexIO/PowerDelivery_PdControllerConfiguration/TypeCPort3SmbusAddr',     '0x23'),
        ('./FlexIO/PowerDelivery_PdControllerConfiguration/USB2PortForTypeCPort3',   'USB2 Port 8'),
        ('./FlexIO/PowerDelivery_PdControllerConfiguration/USB3PortForTypeCPort3',   'Type-C Port 3'),
        ...
        ('./FlexIO/PowerDelivery_PdControllerConfiguration/TypeCPort4RetimerConfig', 'No'),
        ('./FlexIO/PowerDelivery_PdControllerConfiguration/TypeCPort4SmbusAddr',     '0x27'),
        ('./FlexIO/PowerDelivery_PdControllerConfiguration/USB2PortForTypeCPort4',   'USB2 Port 6'),
        ('./FlexIO/PowerDelivery_PdControllerConfiguration/USB3PortForTypeCPort4',   'Type-C Port 4'),
        ('./Gpio/ThunderboltLsxBssb-LsConfiguration/TbltLsxBssbLs0Cfg',              'Legacy VCCIO'),
        ('./Gpio/ThunderboltLsxBssb-LsConfiguration/TbltLsxBssbLs1Cfg',              'Legacy VCCIO'),
        ])
