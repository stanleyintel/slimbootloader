...
def get_xml_change_list (platform, plt_params_list):
    ...
    xml_change_list.append ([
      ...
      #Region Order
        ...
        ('./FlashSettings/VsccTable/VsccEntries/VsccEntry[2]/VsccEntryName',            'MyDemo1'),
        ('./FlashSettings/VsccTable/VsccEntries/VsccEntry[2]/VsccEntryActive',          'True'),
        ('./FlashSettings/VsccTable/VsccEntries/VsccEntry[3]/VsccEntryName',            'MyDemo2'),
        ('./FlashSettings/VsccTable/VsccEntries/VsccEntry[3]/VsccEntryActive',          'True'),
