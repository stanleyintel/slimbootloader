...
CONST UINT64 mSerialIoUartFixedAddress [] = {
  ...
  )
{
  ...
  for (Index = 0; Index < Length ; Index++) {
    ...
    if ((FspsConfig->SerialIoUartMode[Index] == 2) || (FspsConfig->SerialIoUartMode[Index] == 3)) {
      PchNvs->UC0[Index] = mSerialIoUartFixedAddress[Index];
    } else {
