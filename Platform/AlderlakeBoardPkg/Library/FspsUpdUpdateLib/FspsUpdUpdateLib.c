...
//  {22, 7, SiPchIntA, 16}, // CSME: WLAN, no interrupts
  ...
  {21, 3, SiPchIntD, 43}, // SerialIo I2C Controller #3, INTA is default, programmed in PCR[SERIALIO] + PCICFGCTRL[4]
  ...
  )
{
  ...
  if (SiCfgData == NULL) {
    ...
    // TSN feature support
#if PLATFORM_RPLS || PLATFORM_RPLP || PLATFORM_RPLPS || PLATFORM_ADLP || PLATFORM_ADLPS || PLATFORM_ADLS
