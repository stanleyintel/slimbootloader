...
Scope(\) {
  ...
  Field(PWMR, DWordAcc, NoLock, Preserve) {
    ...
    RPD2, 1,          // BIT19 : PCIE D, Function 2
    ...
    RDMI, 1,          // BIT25 : DMI
    RUF1, 1,          // BIT26 : UFS1
    RPF0, 1,          // BIT27 : PCIE F, Function 0
    RPF1, 1,          // BIT28 : PCIE F, Function 1
    RPF2, 1,          // BIT29 : PCIE F, Function 2
    RPF3, 1,          // BIT30 : PCIE F, Function 3
    RTSN, 1,          // BIT31 : GbE TSN
    ...
    APD2, 1,          // BIT19 : PCIE D, Function 2
    ...
    ADMI, 1,          // BIT25 : DMI
    AUF1, 1,          // BIT26 : UFS1
    APF0, 1,          // BIT27 : PCIE F, Function 0
    APF1, 1,          // BIT28 : PCIE F, Function 1
    APF2, 1,          // BIT29 : PCIE F, Function 2
    APF3, 1,          // BIT30 : PCIE F, Function 3
    ATSN, 1,          // BIT31 : GbE TSN
